...
$string['deprecation_notice_heading'] = 'BNX migration completed';
$string['deprecation_notice_desc'] = 'BNX (version 2026040100 or newer) already includes reminders migration. This plugin must remain disabled and should be uninstalled by the administrator.';
...
$string['privacy:metadata:preference:bbbext_bnreminders'] = 'Whether to receive reminders about upcoming sessions of a BigBlueButton activity.';
